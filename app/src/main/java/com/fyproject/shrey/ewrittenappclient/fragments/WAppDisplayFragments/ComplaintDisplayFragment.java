...
public class ComplaintDisplayFragment extends Fragment {
                    ...
                    builder.setPositiveButton("Reject", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            if( !TextUtils.isEmpty(etResponseInput.getText()) )
                                complaintApp.response = etResponseInput.getText().toString();
    ...
    private void downloadAttachment() {
        if (complaintApp.attachedFile != "null") {
            ...
            final File localFile = new File(rootPath, complaintApp.attachedFile);
            fileUri = localFile.toURI();
            StorageReference ref = storageRef.child(complaintApp.attachedFile);
    ...
    public void UpdateStatus(String status){
        String wAppPath1="/applicationsNode/"+complaintApp.toUid+"/"+complaintApp.getwAppId();
